...
<div class="person"  style="width: 24px;height: 24px;background: url(/image/catalog/user/person.png) no-repeat 0px 0px;z-index: 99999;position: absolute;top: 84px;right: 75px;cursor: pointer;">
</div>
		...
		<div class="megamenu-pattern">
			<div class="container">
				<ul class="megamenu <?php if($ustawienia['animation'] != '') { echo $ustawienia['animation']; } ?>">
					...
					<li class="home"><a style="color: #aaa" href="<?php echo $home; ?>"><?php if($ustawienia['home_item'] == 'icon') { ?><i class="fa fa-home"></i><?php } else { echo '<span><strong>'.$home_text.'</strong></span>'; } ?></a></li>
					<?php } ?>
