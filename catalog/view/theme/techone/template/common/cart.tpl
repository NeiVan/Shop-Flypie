...
<div id="cart_block" class="dropdown">
	<div class="cart-heading dropdown-toogle" data-toggle="dropdown" data-hover="dropdown">
		...
		<span class="text2">
			<?php if($theme_options->get( 'shopping_cart_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'shopping_cart_text', $config->get( 'config_language_id' ) ); } else { echo $text_total_cart; } ?></span>
		</span>
	</div>
