          ...
          <div class="col-sm-10">
            <select name="country_id" id="input-country" class="form-control">
              ...
              <?php if ($country['country_id'] == $country_id) { ?>
                   <?php if($text_select == '--- 请选择 --- ') { ?>
                       <option value="<?php echo $country['country_id']; ?>" selected="selected"><?php echo $country['chinese_name']; ?></option>
                   <?php } else { ?>
                       <option value="<?php echo $country['country_id']; ?>" selected="selected"><?php echo $country['name']; ?></option>
                   <?php } ?>
              <?php } else { ?>
                    <?php if($text_select == '--- 请选择 --- ') { ?>
                    <option value="<?php echo $country['country_id']; ?>"><?php echo $country['chinese_name']; ?></option>
                    <?php } else { ?>
...
$('select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: 'shipping-country.html&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
		...
		success: function(json) {
			...
			if (json['zone'] && json['zone'] != '') {
				for (i = 0; i < json['zone'].length; i++) {
					...
					if('--- 请选择 --- '=='<?php echo $text_select; ?>'){
                        html += '>' + json['zone'][i]['chiese_name'] + '</option>';
                    }else{
