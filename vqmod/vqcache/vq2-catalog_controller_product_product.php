...
if (strlen($product_info['youtube']) > 4) { 
	$data['youtubes'] = array();
	...
	$data['youtubes'] = $youtubes;
			...
			$data['lang'] = $this->language->get("text_language");
	...
	public function review() {
		...
		$pagination->limit = 5;
		$pagination->url = $this->url->link('product-review.html', 'product_id=' . $this->request->get['product_id'] . '&page={page}');
