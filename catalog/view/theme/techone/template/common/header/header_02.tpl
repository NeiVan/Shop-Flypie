				...
				<div class="pattern">
					...
					<div class="menu-background">
						<div class="overflow-megamenu container two-modules">
							<!-- Logo Content -->
							<div style="z-index: 27;" class="col-xs-12 col-sm-12 col-md-12 col-lg-3" id="header-left">
								<?php if ($logo) { ?>
								<!-- Logo -->
								<div  style="padding-top: 13px" class="logo"><a href="<?php echo $home; ?>"><img style="width: 40px" src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" /></a></div>
								<?php } ?>
							</div>
							<div class="relative">
								<?php
