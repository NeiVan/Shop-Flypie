...
class ControllerProductSpecial extends Controller {
	public function index() {
		...
		$data['order'] = $order;
		$data['limit'] = $limit;
        $data['addToCompare'] = $this->language->get('text_add_to_compare');
        $data['addToWishlist'] = $this->language->get('text_add_to_wishlist');
        $data['quickview'] =$this->language->get('text_quickview');
        $data['grid'] =$this->language->get('text_grid');
        $data['list'] =$this->language->get('text_list');
