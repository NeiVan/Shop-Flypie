...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
  <fieldset id="account">
    ...
    <div class="form-group required" style="display: <?php if(count($customer_groups) > 1) { ?> block <?php } else { ?> none <?php } ?>;">
...
<script type="text/javascript"><!--
    ...
    $('input[name=\'customer_group_id\']').on('change', function() {
        $.ajax({
            url: 'register-customfield.html&customer_group_id=' + this.value,
            dataType: 'json',
