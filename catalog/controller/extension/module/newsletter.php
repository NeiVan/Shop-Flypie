...
class ControllerExtensionModuleNewsletter extends Controller {
    public function getText($text) {
        ...
        if($subscribe_message == '') $subscribe_message = $this->language->get('subscribe_message');
        if($unsubscribe_message == '') $unsubscribe_message = $this->language->get('unsubscribe_message');
        if($confirm_unsubscribe == '') $confirm_unsubscribe = $this->language->get('confirm_unsubscribe');
        if($invalid_email_message == '') $invalid_email_message = $this->language->get('invalid_email_message');
        if($email_not_found == '') $email_not_found = $this->language->get('email_not_found');
