...
<head>
     ...
     $lista_plikow[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/commontwo.js';
  		...
  		<div class="col-sm-12">
  			<div class="row" id="quickview_product">
			    ...
			    <div class="col-sm-<?php echo $product_center_grid; ?> product-center clearfix">
				 ...
				 <div style="margin-top: 15px" class="share">
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				parent.$('#cart_block #cart_content').load('cart-info.html #cart_content_ajax');
				parent.$('#cart_block #total_price_ajax').load('cart-info.html #total_price');
				parent.$('#cart_block #cart_count_ajax').load('cart-info.html #cart_count');
